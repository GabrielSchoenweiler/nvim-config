...
keymap.set("n", "<A-ScrollWheelUp>", '<cmd>call utils#SwitchLine(line("."), "down")<cr>', { desc = "move line down" })
keymap.set("n", "<A-ScrollWheelDown>", '<cmd>call utils#SwitchLine(line("."), "up")<cr>', { desc = "move line up" })
